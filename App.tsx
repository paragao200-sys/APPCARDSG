               ...
               <div className="relative mb-12">
                 <div className="absolute -inset-16 pointer-events-none opacity-20">
                  ...
                  <Tooltip content={targetColor === 'TIE' ? "Probabilidade de empate detectada" : `Entrada confirmada para ${
                    targetColor === 'BLUE' 
                      ? (selectedGame === 'BACCARAT' ? 'PLAYER' : selectedGame === 'FOOTBALL_STUDIO' ? 'VISITANTE' : 'PLAYER') 
                      : (selectedGame === 'BACCARAT' ? 'BANKER' : selectedGame === 'FOOTBALL_STUDIO' ? 'CASA' : 'BANKER')
                  }`}>
                    <motion.div 
                      animate={{ 
                        y: [0, -10, 0],
                    ...
                    >
                      ...
                      <motion.h3 
                       ...
                       >
                         {targetColor === 'BLUE' ? (selectedGame === 'BACCARAT' ? 'PLAYER' : selectedGame === 'FOOTBALL_STUDIO' ? 'AWAY' : 'PLAYER') : 
                          targetColor === 'RED' ? (selectedGame === 'BACCARAT' ? 'BANKER' : selectedGame === 'FOOTBALL_STUDIO' ? 'HOME' : 'BANKER') : 'EMPATE'}
                       </motion.h3>
